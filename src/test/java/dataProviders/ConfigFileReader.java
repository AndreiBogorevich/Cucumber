...
public class ConfigFileReader {
	...
	public ConfigFileReader() {
		...
		try {
			...
			throw new RuntimeException(
					"Configuration file failed to load from " + sConfigFilePath);
		}
	}
	...
	public String getBrowser() {
		...
		if (sBrowser != null) {
			...
			throw new RuntimeException(
					"Browser is not specified in the configuration file.");
		}
	}
	...
	public String getStartingUrl() {
		...
		if (sStartingUrl != null) {
			...
			throw new RuntimeException(
					"Starting Url is not specified in the configuration file.");
		}
	}
	...
	public long getImplicitWait() {
		...
		if (sImplicitWait != null) {
			...
			throw new RuntimeException(
					"Implicit Wait is not specified in the configuration file.");
		}
	}
	...
	public long getExplicitWait() {
		...
		if (sExplicitWait != null) {
			...
			throw new RuntimeException(
					"Explicit Wait is not specified in the configuration file.");
		}
	}
	...
	public String getFirefoxProfile() {
		...
		if (sFirefoxProfile != null) {
			...
			throw new RuntimeException(
					"Firefox Profile is not specified in the configuration file.");
		}
	}
	...
	public String getExecutablesPath() {
		...
		if (sExecutablesPath != null) {
			...
			throw new RuntimeException(
					"Executables path is not specified in the configuration file.");
		}
	}
	...
	public boolean getUseFirefoxBinary() {
		...
		if (sFlag != null) {
			...
			throw new RuntimeException(
					"Use Firefox Binary flag is missing in the configuration file.");
	...
	public String getFirefoxBinary() {
		...
		if (sFirefoxBinary != null) {
			...
			throw new RuntimeException(
					"Firefox Binary path is not specified in the configuration file.");
		}
	}
	...
	public boolean getMaximizeBrowser() {
		...
		if (sMaximize != null) {
			if (sMaximize.equalsIgnoreCase("y")
					|| sMaximize.equalsIgnoreCase("true")) {
				return true;
			} // flag is not null and set to yes
			else {
				return false;
			...
			throw new RuntimeException(
					"Use MaximizeBrowser flag is missing in the configuration file.");
		} // flag is not setm i.e. is null
	}
	...
	public String getTestDataPath() {
		...
		if (sTestDataPath != null) {
			...
			throw new RuntimeException(
					"Test Data path is not specified in the configuration file.");
		}
	}
